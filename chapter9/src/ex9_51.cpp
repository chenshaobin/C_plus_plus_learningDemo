...
unsigned Date::MonthFromName(const std::string& str)
{
	...
	if (isdigit(str[0])) return std::stoi(str);
...
int main()
{
	...
	{ //  case 0: August 19, 2020
		auto date = Date("August 19, 2020");
		date.Print();
	}
	{ //  case 1: 1/1/1900
		auto date = Date("8/19/2020");
		date.Print();
	}
	{ //  case 2: Jan 1, 1900
		auto date = Date("Aug 19, 2020");
		date.Print();
	}
	/*
	
	{ //  case 3: Aug192020
		auto date = Date("Aug192020");
		date.Print();
	}
	*/
}